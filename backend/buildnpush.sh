...
docker tag xmlconverter:latest 307654412330.dkr.ecr.us-east-1.amazonaws.com/xmlconverter:$version
docker push 307654412330.dkr.ecr.us-east-1.amazonaws.com/xmlconverter:$version